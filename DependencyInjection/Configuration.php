                ...
                ->arrayNode('providers')
                    ...
                    ->children()
                        ...
                        ->arrayNode('heredotcom')
                            ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('api_key')->defaultValue('%your_heredotcom_api_key%')->end()
                                    ->scalarNode('api_endpoint')->defaultValue('http://geocoder.cit.api.here.com/6.2/geocode.json;http://reverse.geocoder.cit.api.here.com/6.2/reversegeocode.json')->end()
